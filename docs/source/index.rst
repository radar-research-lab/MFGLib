...
.. toctree::
    ...
    contributing
    license
    Changelog <https://github.com/radar-research-lab/MFGLib/blob/main/CHANGELOG.md>
...
MFGLib is an open-source Python library designed to facilitate research into mean-field games (MFGs).
The library provides an intuitive and flexible platform for developing, testing, and experimenting with
MFG algorithms and environments.
...
We recommend newcomers start with our :doc:`quickstart` tutorial.
